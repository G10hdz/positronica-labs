...
const translations = {
  en: {
    ...
    index: {
      heroSubtitle: '> V.01',
      heroTitle: 'AI FOR A FAIRER FUTURE',
      heroDesc: '> BUILDING AI TOOLS THAT CLOSE GAPS, NOT WIDEN THEM.',
      exploreBtn: 'Explore Labs',
      ethicsBtn: 'View Ethics',
      projectsLabel: 'ACTIVE PROJECTS',
      projectsHeading: 'The Ecosystem',
  ...
  es: {
    ...
    index: {
      heroSubtitle: '> V.01',
      heroTitle: 'IA PARA UN FUTURO MÁS JUSTO',
      heroDesc: '> CONSTRUIMOS HERRAMIENTAS DE IA QUE CIERRAN BRECHAS, NO LAS AMPLÍAN.',
      exploreBtn: 'Explorar Labs',
      ethicsBtn: 'Ver Ética',
      projectsLabel: 'PROYECTOS ACTIVOS',
      projectsHeading: 'El Ecosistema',
      missionLabel: '> MISIÓN_PRINCIPAL',
      missionHeading: 'El Laboratorio',
      missionBody:
        'Positronica Labs es un laboratorio de tecnología construido por mujeres, para todos. Lanzamos herramientas que hacen el trabajo más justo, el aprendizaje adaptativo y la automatización accesible.',
